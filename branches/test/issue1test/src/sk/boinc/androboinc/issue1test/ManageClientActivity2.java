...
public class ManageClientActivity2 extends PreferenceActivity {
	private static final String TAG = "ManageClientActivity2";
	...
	private class SavedState {
		...
		public void restoreState(ManageClientActivity2 activity) {
			activity.mTest = test;
