...
public class ManageClientActivity5 extends PreferenceActivity {
	private static final String TAG = "ManageClientActivity5";
	...
	private class SavedState {
		...
		public void restoreState(ManageClientActivity5 activity) {
			activity.mTest = test;
