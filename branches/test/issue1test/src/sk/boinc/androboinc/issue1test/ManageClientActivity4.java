...
public class ManageClientActivity4 extends PreferenceActivity {
	private static final String TAG = "ManageClientActivity4";
	...
	private class SavedState {
		...
		public void restoreState(ManageClientActivity4 activity) {
			activity.mTest = test;
...
//		requestWindowFeature(Window.FEATURE_INDETERMINATE_PROGRESS);
		...
		addPreferencesFromResource(R.xml.manage_client_4);
